...
class Food:
    def __init__ (self):
        x = random.randint(0, (GAME_WITH/SPACE_SIZE)-1) * SPACE_SIZE    
...
def game_over():
    canvas.delete(ALL)
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2, font=('consoles',50), text="GAME OVER", fill="red", tag="gameover")
window = Tk()
